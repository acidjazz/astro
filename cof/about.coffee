About =
  ...
  handlers: ->
    ...
    $('.about > .fcontainer > .filters > .inner > .filtermenu > .filter, .info.emails > a.p').on 'click',
      About.menuHandler
  ...
  menu: (section) ->
    ...
    _.on ".fcontainer > .filters > .inner > .filtermenu > .filter.filter_#{section}",
      ".sections > .section.section_#{section}"
